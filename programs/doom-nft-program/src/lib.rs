...
mod anchor_api {
    #![allow(deprecated)] // Anchor 0.31 expands #[program] through deprecated AccountInfo::realloc generated code.
    ...
    pub mod doom_nft_program {
        ...
        pub fn transfer_admin(ctx: Context<TransferAdmin>) -> Result<()> {
            instructions::transfer_admin::process_transfer_admin(ctx)
        }
